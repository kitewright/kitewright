...
// napi-generated loader (binding.js): resolves the per-platform prebuilt package
// (@kitewright/node-<os>-<arch>) when installed from npm, falling back to the
// local `kitewright-node.<triple>.node` during development. Regenerated by
// `napi build --platform --js binding.js` (see package.json "build").
